...
<template>
  ...
  <div>
	...
	<div v-else>
		...
		<!-- Main Form -->
		<div v-else>
			<h3 class="text-2xl sm:text-3xl text-center text-gray-900">Kentucky Watershed Watch Monitoring Data Form</h3>
			...
			<Form @submit.prevent="submitData">
				...
				<div class="border-4 p-1 border-gray-900">
					...
					<div class="flex flex-col sm:flex-row">
						<UFormGroup class="p-2 w-full sm:w-1/2" required>
					...
					<div class="flex flex-col md:flex-row">
						<UFormGroup class="p-2 w-full md:w-1/2">
						...
						<UFormGroup class="p-2 w-full md:w-1/2">
							...
							<UButton label="Open Map" @click="openMap" class="w-full md:w-auto" />
						</UFormGroup>
					</div>
					<div class="flex flex-col md:flex-row">
						<UFormGroup class="p-2 w-full md:w-1/2" required>
					...
					<div class="flex flex-col md:flex-row flex-wrap">
						<UFormGroup class="p-2 w-full sm:w-1/2 md:w-1/4" required>
						...
						<UFormGroup class="p-2 w-full sm:w-1/2 md:w-1/4">
				...
				<div class="border-4 p-1 border-gray-900">
					<div class="flex flex-col md:flex-row">
						<UFormGroup class="p-2 w-full md:w-1/3">
						...
						<UFormGroup class="p-2 w-full md:w-1/3 md:border-l md:border-gray-500">
					...
					<div class="flex flex-col md:flex-row">
						...
						<UFormGroup class="p-2 w-full md:w-1/2 md:border-l md:border-gray-500">
				...
				<div class="flex flex-col md:flex-row">
					<div class="border-4 p-1 border-gray-900 w-full md:w-1/2">
						<UFormGroup class="p-2 w-full">
				...
				<div class="flex flex-col md:flex-row">
					<div class="border-4 p-1 border-gray-900 w-full md:w-1/2">
						<div class="flex items-center p-2">
							...
							<span class="ml-2">Meter Calibration</span>
						</div>
						<div class="p-2">
							<div class="mb-2">Conductivity Meter</div>
							<UFormGroup class="mb-4" label="Calibration Date">
								<UInput v-model="conductivityMeterCalibrationDate" type="date" />
							</UFormGroup>
							<div class="mb-2">Other Meter</div>
							<UFormGroup class="mb-4" label="Calibration Date">
				...
				<div class="border-4 p-5 border-gray-900">
					...
					<template v-if="useRCard">
						...
						<div class="flex items-center">
							...
							alt="Bacteria"
							class="w-16 sm:w-20 mr-2 sm:mr-4"
							/>
						</div>
						<h2 class="text-lg sm:text-xl font-bold mr-4 flex-shrink-0">Bacteria: R-Card Method</h2>
						</div>
						<div class="flex items-center mb-4">
						<p class="text-center bact-msg">Time Out should be between 20 and 24 hrs at 35-38°C after placing cards in incubator</p>
						</div>
						
						<!-- Responsive layout for R-Card section -->
						<div class="space-y-6">
						<!-- Top section with time inputs -->
						<div class="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-6">
							...
							<!-- Right Column - E.coli counts - Responsive layout -->
							<div class="border-t lg:border-t-0 lg:border-l border-gray-200 pt-4 lg:pt-0 lg:pl-6">
								<!-- Mobile-friendly E.coli layout -->
								<div class="space-y-6">
									<!-- Headers only visible on larger screens -->
									<div class="hidden md:grid grid-cols-[auto_1fr_auto_1fr_auto_1fr] gap-2">
										<div></div>
									...
									<!-- Sample A -->
									<div class="space-y-2 md:space-y-0 md:grid md:grid-cols-[auto_1fr_auto_1fr_auto_1fr] md:gap-2 md:items-center pb-2 border-b border-gray-100">
										<label class="block md:inline text-sm whitespace-nowrap required-field">Sample A:</label>
										<div class="w-full">
											<label class="block md:hidden text-xs font-semibold whitespace-nowrap required-field"># E.coli/card</label>
											<UInput v-model="ecoliA_count" type="number" required />
										</div>
										<span class="hidden md:block self-center text-sm font-semibold px-1">÷</span>
										<div class="w-full">
											<label class="block md:hidden text-xs font-semibold whitespace-nowrap required-field">Sample Vol (mL)</label>
											<USelect
											v-model="sampleVolA"
										...
										<span class="hidden md:block self-center text-sm font-semibold px-1 whitespace-nowrap">× 100 =</span>
										<div class="w-full">
											<label class="block md:hidden text-xs font-semibold whitespace-nowrap">E.coli/100mL</label>
									...
									<!-- Sample B -->
									<div class="space-y-2 md:space-y-0 md:grid md:grid-cols-[auto_1fr_auto_1fr_auto_1fr] md:gap-2 md:items-center pb-2 border-b border-gray-100">
										<label class="block md:inline text-sm whitespace-nowrap required-field">Sample B:</label>
										<div class="w-full">
											<label class="block md:hidden text-xs font-semibold whitespace-nowrap required-field"># E.coli/card</label>
									...
									<!-- Sample C -->
									<div class="space-y-2 md:space-y-0 md:grid md:grid-cols-[auto_1fr_auto_1fr_auto_1fr] md:gap-2 md:items-center">
										<label class="block md:inline text-sm whitespace-nowrap required-field">Sample C:</label>
										<div class="w-full">
											<label class="block md:hidden text-xs font-semibold whitespace-nowrap required-field"># E.coli/card</label>
						...
						<div class="border-t border-gray-200 pt-4">
							...
							<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-1 gap-y-1">
							...
							<div v-if="bacterialSourceOther" class="mt-1">
				...
				<div class="flex flex-col md:flex-row">
					...
					<UFormGroup class="p-2">
						...
						v-model="otherObs" 
						rows="10"
						class="w-full min-h-[120px] md:min-h-[200px] resize-y"
				...
				<div class="flex flex-col md:flex-row">
					...
					<!-- Submit and Cancel Buttons - Fixed at bottom on mobile -->
					<div class="sticky bottom-0 left-0 right-0 bg-white p-4 border-t border-gray-200 shadow-md md:shadow-none md:static md:bg-transparent md:border-0 md:flex md:justify-end md:space-x-4 md:mt-6 z-10">
						<UButton
						...
						<UButton
							...
							class="w-full md:w-auto text-gray-900"
							variant="solid"
		...
		<Teleport to="body">
			<Transition name="fade">
				...
				<div ref="mapModalRef" class="bg-white rounded-lg p-4 w-full h-full md:max-w-[750px] md:w-full md:max-h-[500px] md:h-full overflow-auto relative">
